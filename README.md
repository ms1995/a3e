...
**This repo contains the artifacts for A3E evaluation in the paper [An Empirical Study of Android Test Generation Tools in Industrial Cases](https://dl.acm.org/citation.cfm?id=3240465). See below for instructions shipped with the original version.**
